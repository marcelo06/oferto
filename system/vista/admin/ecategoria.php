...
<div id="new-task" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="container-fluid" id="content">
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="producto-list_productos">Empresas</a>
			...
			<div class="box box-color box-bordered lightgrey">
							...
							<div class="box-content nopadding">
								<ul class="basiclist">
									...
									<li id="li_<?=$cate['id_categoria']?>">
										...
										<span class="task-actions">
											...
											<a href="empresa-cgaleria-categoria-<?=$cate['id_categoria']?>" class='task-delete box_banner' rel="tooltip" title="Ver Galeria"><i class="icon-picture"></i></a>
											<a href="javascript:delete_cate(<?=$cate['id_categoria']?>)" class='task-delete' rel="tooltip" title="Borrar esta categoría"><i class="icon-remove"></i></a>
								...
								<div class="form-actions">
										...
										<button type="button" class="btn" onClick="location = 'empresa-list_empresas'">Cancelar</button>
									</div>
        ...
        <script type="text/javascript" src="<?= URLVISTA ?>admin/js/ecategoria.js"></script>
