	...
	<div class="container-fluid" id="content">
		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
                    <a class="btn btn-primary btn-large" href="contenido-editar" > Agregar Contenidos </a> <a class="edit_categoria btn btn-large" href="arbol_menu-categorias" > Administrar Categorías </a>  
        ...
        <? include("includes/footer.php") ?>
		    ...
		    <script src="<?= URLVISTA ?>admin/js/list_contenidos.js"></script>
	</body>
	</html>
