            ...
            return this.each(function() {
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                        ...
                        file.queueItem.find('.fileinfo').append('<a class="up" onclick="alert(\'asas\')"></a>');
                        file.queueItem.find('.fileinfo').append('<a class="down" onclick=""></a>');
                        file.queueItem.find('.fileinfo').append('<a class="preview" onclick=""></a>');
                        //file.queueItem.find('.fileinfo').html('display','block');
                        //file.queueItem.addClass('vista');
                    }
