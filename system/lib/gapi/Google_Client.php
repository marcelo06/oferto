...
// $path = 'system/model/gapi/';
// $path = '';

// Include the top level classes, they each include their own dependencies
require_once $path.'service/Google_Model.php';
require_once $path.'service/Google_Service.php';
require_once $path.'service/Google_ServiceResource.php';
require_once $path.'auth/Google_AssertionCredentials.php';
require_once $path.'auth/Google_Signer.php';
require_once $path.'auth/Google_P12Signer.php';
require_once $path.'service/Google_BatchRequest.php';
require_once $path.'external/URITemplateParser.php';
require_once $path.'auth/Google_Auth.php';
require_once $path.'cache/Google_Cache.php';
require_once $path.'io/Google_IO.php';
require_once($path.'service/Google_MediaFileUpload.php');
