	...
	<div class="container-fluid" id="content">
		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
                    <a class="btn btn-primary btn-large" href="mailing-editar" > Nuevo Mailing </a> 
						<div class="box box-color box-bordered">
							...
							<div class="box-content nopadding">
								...
								<table class="table table-hover table-nomargin table-bordered " id="mailings">
									 <?= $tabla ?>
        ...
        <? include("includes/footer.php") ?>
		    ...
		    <script src="<?= URLVISTA ?>admin/js/list_mailings.js"></script>
